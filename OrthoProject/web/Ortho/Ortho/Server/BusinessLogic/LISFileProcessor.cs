...
namespace Ortho.Server.BusinessLogic
{
    public class LISFileProcessor
    {
        ...
        private const string DB_FUNCTION_POPULATE_LIS_STAT = "public.\"populateLisStatMapping\"";
        ...
        private static int MapHeaders(OrthoDBContext dbContext, int iUser, int iScenario, int iLISId, String[] arrHeaders, String[] arrSamples)
        {
            ...
            var setRecsToDelete = dbContext.demandFileColumnMappings
                    .Where(m => m.scenarioId == iScenario && m.lisSetId == iLISId);
...

        {
            ...
            // Call to populate the list of STAT/Priority values
            dbContext.Database.ExecuteSqlRaw("SELECT " + DB_FUNCTION_POPULATE_LIS_STAT + "(" + iScenario + "," + iLISId + ")");
            ////////////////////////////////////////////////////////////////////////////////////////////////////
