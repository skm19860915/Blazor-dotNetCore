...
namespace Ortho.Server.Controllers
{
    ...
    public class DemandController : ControllerBase
    {
        ...
        [HttpPost("createlisfile")]
        public async Task<IActionResult> CreateLISFileAsync([FromBody] LISFilePostViewModel lisFilePostViewModel)
        {
            var lisFileId = await _provider.CreateLISFileAsync(lisFilePostViewModel);
            return Ok(lisFileId);
        }
        ...
        [HttpGet("checkscenariowithlisfile/{lisFileId}")]
        public async Task<IActionResult> CheckScenarioWithLISFileAsync(int lisFileId)
        {
            var isFoundScenario = await _provider.CheckScenarioWithLISFileAsync(lisFileId);
            return Ok(isFoundScenario);
        }
    }
}
